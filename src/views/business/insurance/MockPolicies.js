...
import { mockPolicies } from "@aegisUtils"

export const renderPoliciesList = [...mockPolicies]
const dealerList = {
  dealerships: [
    {
      dealership: {
...
export const policiesListColumns = [
  {
    name: "Customer",
    minWidth: "160px",
    selector: "name",
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="d-flex justify-content-left align-items-center">
        <div className="d-flex flex-column">
          <span className="font-weight-bold">{row?.policyId}</span>
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="d-flex justify-content-left align-items-center">
        <div className="d-flex flex-column">
          <span className="font-weight-bold text-primary">&#8377; {row?.premium}</span>
          {/* <small className="text-truncate text-muted mb-0">{row?.city}</small> */}
        </div>
      </div>
    )
    ...
    cell: (row) => (
      <UncontrolledDropdown>
        ...
        <DropdownMenu right>
          <DropdownItem
            tag={Link}
            to={`/business/insurance/${row.policyId}`}
            className="w-100"
